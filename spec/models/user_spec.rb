...
describe User do
  ...
  it "should accept valid email addresses" do
    ...
    addresses.each do |address|
      valid_email_user = @company.users.new(@attr.merge(:email => address))
  ...
  it "should reject invalid email addresses" do
    ...
    addresses.each do |address|
      invalid_email_user = @company.users.new(@attr.merge(:email => address))
  ...
  it "should reject duplicate email addresses" do
    ...
    @company.users.create!(@attr)
    user_with_duplicate_email = @company.users.new(@attr)
    user_with_duplicate_email.should_not be_valid
  end
  
  it "should reject email addresses identical up to case" do
    upcased_email = @attr[:email].upcase
    @company.users.create!(@attr.merge(:email => upcased_email))
    user_with_duplicate_email = @company.users.new(@attr)
    user_with_duplicate_email.should_not be_valid
  end
